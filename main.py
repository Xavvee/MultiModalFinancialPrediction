...
import time
import shutil
from models import random_walk, majority_baseline, arima, arima_stationary, lstm, lstm_stationary, gru_multimodal, dashboard
...
def main():
    ...
    for ticker in ASSETS:
        ...
        try:
            ...
            gru_multimodal.run(ticker, asset_dir, dataset_pkl='data/new_dataset/processed/full_dataset_whales_2021_23.pkl')
