...
# Matched to the span of the sentiment corpus (full_dataset_whales_2021_23.pkl,
# 2021-02-05 .. 2023-01-09). The price-only models must be scored on the same
# period as the sentiment model, or the benchmark table compares disjoint eras:
# with the previous 2020-2026 default the 80/20 split put the price models in
# 2024-26 while the GRU was validating on 2021-23, and the two never overlapped.
def get_data(ticker="BTC-USD", start="2021-02-01", end="2023-01-10"):
